...
1. Στη σελίδα **Προσαρμοσμένα μοντέλα**, επιλέξτε τα κατακόρυφα αποσιωπητικά (&vellip;) στη στήλη **Ενέργειες** που βρίσκεται δίπλα σε μια ροή εργασιών που δημιουργήσατε προηγουμένως και επιλέξτε **Επεξεργασία**.
...
1. Στη σελίδα **Προσαρμοσμένα μοντέλα**, επιλέξτε τα κατακόρυφα αποσιωπητικά (&vellip;) στη στήλη **Ενέργειες** που βρίσκεται δίπλα σε μια ροή εργασιών που δημιουργήσατε προηγουμένως.

1. Επιλέξτε **Εκτέλεση**.

Η ροή εργασιών σας εκτελείται επίσης αυτόματα με κάθε προγραμματισμένη ανανέωση. Μάθετε περισσότερα σχετικά με τη [ρύθμιση προγραμματισμένων ανανεώσεων](schedule-refresh.md).
