...
Εάν ένας πελάτης έχει συμμετάσχει σε μια ρυθμισμένη δραστηριότητα, θα τη βρείτε στην ενότητα **Χρονοδιαγράμματος δραστηριοτήτων**.
