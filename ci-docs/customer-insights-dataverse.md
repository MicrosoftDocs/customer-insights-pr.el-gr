...
Οι διαχειριστές μπορούν να ρυθμίσουν τις παραμέτρους του Customer Insights [ώστε να χρησιμοποιούν ένα υπάρχον περιβάλλον Dataverse](create-environment.md) όταν δημιουργούν ένα περιβάλλον Customer Insights. Παρέχοντας τη διεύθυνση URL στο περιβάλλον Dataverse, επισυνάπτεται στο νέο περιβάλλον Customer Insights. Τα περιβάλλοντα Customer Insights και Dataverse πρέπει να φιλοξενούνται στην ίδια περιοχή. 
...
> [!NOTE]
> Εάν οι οργανισμοί σας χρησιμοποιούν ήδη Dataverse στον μισθωτή τους, είναι σημαντικό να θυμάστε ότι η [δημιουργία περιβάλλοντος Dataverse ελέγχεται από έναν διαχειριστή](/power-platform/admin/control-environment-creation). Για παράδειγμα, αν ρυθμίζετε ένα νέο περιβάλλον Customer Insights με τον λογαριασμό σας στο οργανόγραμμα και ο διαχειριστής έχει απενεργοποιήσει τη δημιουργία δοκιμαστικού περιβάλλοντος Dataverse για όλους εκτός από διαχειριστές, δεν μπορείτε να δημιουργήσετε ένα νέο δοκιμαστικό περιβάλλον.
> 
