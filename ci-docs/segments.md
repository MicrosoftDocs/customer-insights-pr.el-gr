...
- Προβείτε σε **Ενεργοποίηση** ή **Απενεργοποίηση** του τμήματος. Τα ανενεργά τμήματα δεν θα ανανεωθούν κατά τη διάρκεια μιας [προγραμματισμένης ανανέωση](system.md#schedule-tab) και να έχουν το **Κατάσταση** παρατίθεται ως **Παράλειψη**, υποδεικνύοντας ότι δεν επιχειρήθηκε καν ανανέωση. Τα ενεργά τμήματα ανανεώνονται με βάση τον τύπο τους: στατικά ή δυναμικά.
...
Για να [προγραμματίσετε την αυτόματη ανανέωση](system.md#schedule-tab), μεταβείτε στην επιλογή **Χρονοδιάγραμμα** > **Σύστημα** > **Χρονοδιάγραμμα**. Ισχύουν οι ακόλουθοι κανόνες:
