...
1. Επιλέξτε μία από τις ακόλουθες επιλογές για τη **Σύνδεση του χώρου αποθήκευσης με χρήση**. Για περισσότερες πληροφορίες, ανατρέξτε στο θέμα [Σύνδεση Customer Insights σε ένα λογαριασμό Azure Data Lake Storage Gen2 με κύριο υπηρεσίας Azure](connect-service-principal.md).
   ...
   - **Πόρος Azure**: Πληκτρολογήστε το **αναγνωριστικό πόρου**. Προαιρετικά, εάν θέλετε να κάνετε πρόσληψη δεδομένων από ένα λογαριασμό χώρου αποθήκευσης μέσω μιας ιδιωτικής σύνδεσης Azure, επιλέξτε **Ενεργοποίηση ιδιωτικής σύνδεσης**. Για περισσότερες πληροφορίες, ανατρέξτε στην ενότητα [Ιδιωτικές συνδέσεις](security-overview.md#private-links-tab).
   - **Συνδρομή Azure**: Επιλέξτε τη **συνδρομή** και, στη συνέχεια, την **ομάδα πόρων** και **λογαριασμό χώρου αποθήκευσης**. Προαιρετικά, εάν θέλετε να κάνετε πρόσληψη δεδομένων από ένα λογαριασμό χώρου αποθήκευσης μέσω μιας ιδιωτικής σύνδεσης Azure, επιλέξτε **Ενεργοποίηση ιδιωτικής σύνδεσης**. Για περισσότερες πληροφορίες, ανατρέξτε στην ενότητα [Ιδιωτικές συνδέσεις](security-overview.md#private-links-tab).
...
1. Επιλέξτε τις οντότητες υπογραφή που θέλετε να συμπεριλάβετε.
   ...
   > [!TIP]
   > Για να επεξεργαστείτε τις οντότητες σε περιβάλλον εργασίας επεξεργασίας JSON, επιλέξτε **Εμφάνιση περισσότερων** > **Επεξεργασία αρχείου σχήματος**. Κάντε τις αλλαγές σας και επιλέξτε **Αποθήκευση**.
...
1. Αλλάξτε οποιαδήποτε από τις παρακάτω πληροφορίες:
   ...
   - Επιλέξτε **Ενεργοποίηση ιδιωτικής σύνδεσης** εάν θέλετε να κάνετε πρόσληψη δεδομένων από ένα λογαριασμό χώρου αποθήκευσης μέσω μιας ιδιωτικής σύνδεσης Azure. Για περισσότερες πληροφορίες, ανατρέξτε στην ενότητα [Ιδιωτικές συνδέσεις](security-overview.md#private-links-tab).
...
1. Αλλάξτε οποιαδήποτε από τα παρακάτω:
   ...
   - Για να αλλάξετε τα δεδομένα αυξητικής πρόσληψης, ανατρέξτε στο [Ρύθμιση παραμέτρων μιας αυξητικής ανανέωσης για προελεύσεις δεδομένων Azure Data Lake](incremental-refresh-data-sources.md)
