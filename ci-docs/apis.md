...
Σε αυτό το άρθρο περιγράφεται ο τρόπος με τον οποίο μπορείτε να αποκτήσετε πρόσβαση στα API του Customer Insights, να δημιουργήσετε μια καταχώρηση εφαρμογής Azure και να ξεκινήσετε με τις βιβλιοθήκες προγράμματος-πελάτη.
...
1. Για να ενεργοποιήσετε τα API στο περιβάλλον του Customer Insights, μεταβείτε στο **Διαχειριστής** > **Ασφάλεια**. Για να το κάνετε αυτό, θα χρειαστείτε δικαιώματα διαχειριστή.

1. Μεταβείτε στην καρτέλα **API** και επιλέξτε το κουμπί **Ενεργοποίηση**.    
 
   Η ενεργοποίηση των API δημιουργεί ένα πρωτεύον και δευτερεύον κλειδί συνδρομής για την παρουσία σας που χρησιμοποιείται στις αιτήσεις API. Μπορείτε να ξαναδημιουργήσετε τα κλειδιά επιλέγοντας το **Ξαναδημιουργία πρωτεύοντος** 'η **Ξαναδημιουργία δευτερεύοντος** στο **Διαχειριστής** > **Ασφάλεια** > **API**.
...
Για περισσότερες πληροφορίες σχετικά με την καταχώρηση εφαρμογής στο Azure, ανατρέξτε στο θέμα [Καταχώρηση μιας εφαρμογής](/graph/auth-register-app-v2).
...
Η [ενότητα καταχώρησης εφαρμογής](#create-a-new-app-registration-in-the-azure-portal) περιγράφει τον τρόπο καταχώρησης μιας εφαρμογής που απαιτεί από έναν χρήστη να συνδεθεί για έλεγχο ταυτότητας. Μάθετε πώς να δημιουργείτε μια καταχώρηση εφαρμογής που δεν χρειάζεται αλληλεπίδραση με το χρήστη και μπορεί να εκτελεστεί σε διακομιστή.
...
1. Συμπερασματικά, πρέπει να προσθέσουμε το όνομα της καταχώρησης εφαρμογής ως χρήστης στο Customer Insights.  
   ...
   Ανοίξτε το Customer Insights, μεταβείτε στο **Διαχειριστής** > **Ασφάλεια** και επιλέξτε **Προσθήκη χρήστη**.
...
Έχουμε συγκεντρώσει μια σύντομη λίστα δειγμάτων ερωτημάτων OData για εργασία με τα API: [Παραδείγματα ερωτημάτων OData](odata-examples.md).
