...
1. Αντιστοιχήστε τα χαρακτηριστικά σημασιών στα πεδία που απαιτούνται για την εκτέλεση του μοντέλου. Εάν τα πεδία που ακολουθούν δεν συμπληρώνονται, ρυθμίστε τις παραμέτρους της σχέσης από την οντότητα ιστορικού αγορών σας στην οντότητα *Πελάτης*.
...
### <a name="provide-an-optional-list-of-benchmark-accounts-business-accounts-only"></a>Παράσχετε μια προαιρετική λίστα λογαριασμών συγκριτικής αξιολόγησης (μόνο επιχειρηματικών λογαριασμών)
