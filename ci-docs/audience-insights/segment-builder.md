...
>    - Βεβαιωθείτε ότι οι προελεύσεις δεδομένων επαφής [αντιστοιχίζονται με σημασιολογική αντιστοίχιση στην οντότητα](semantic-mappings.md#define-a-contactprofile-semantic-entity-mapping) ContactProfile.
