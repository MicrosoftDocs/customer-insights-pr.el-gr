...
1.  Μπορείτε να προσθέσετε επιπλέον πεδία για συμμετοχή στη διαδικασία συγχώνευσης.
...
1. Στη σελίδα **Συγχώνευση**, επιλέξτε την καρτέλα **Κλειδιά**. 
