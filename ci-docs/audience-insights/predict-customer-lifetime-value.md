...
---
# <a name="customer-lifetime-value-clv-prediction-preview"></a>Πρόβλεψη τιμής πελατειακής διάρκειας (CLV) (προεπισκόπηση)
...
- Ιστορικό συναλλαγών: Ιστορικό αρχείο καταγραφής συναλλαγών με το παρακάτω σχήμα σημασιολογικών δεδομένων
    ...
    - Ημερομηνία συναλλαγής: Ημερομηνία, κατά προτίμηση χρονική σήμανση κάθε συναλλαγής
    - Ποσό συναλλαγής: Χρηματική αξία (π.χ. έσοδα ή περιθώριο κέρδους) της κάθε συναλλαγής
    - Ετικέτα που έχει αντιστοιχιστεί σε επιστροφές (προαιρετικά): Δυαδική τιμή που δηλώνει αν η συναλλαγή είναι επιστροφή 
...
1. Στο τμήμα παραθύρου **Τιμή ζωής πελάτη (προεπισκόπηση)**, επιλέξτε **Έναρξη**.
...
1. Ορίστε **Χρονική περίοδο πρόβλεψης** για να καθορίσετε πόσο μακριά στο μέλλον θέλετε να ορίστε το CLV.    
   ...
   > [!TIP]
   > Για να προβλέψετε με ακρίβεια το CLV για τη χρονική περίοδο που ορίζετε, χρειάζεστε μια ανάλογη περίοδο ιστορικών δεδομένων. Για παράδειγμα, εάν θέλετε να προβλέψετε για τους επόμενους 12 μήνες, συνιστάται να έχετε ιστορικά δεδομένα διάρκειας τουλάχιστον 18 – 24 μηνών.
...
- **Επιδόσεις μοντέλου εκπαίδευσης**: Οι Α, Β ή C είναι πιθανοί βαθμοί. Αυτός ο βαθμός υποδεικνύει την απόδοση του προϊόντος πρόβλεψη μπορεί να σας βοηθήσει να επιλέξετε να χρησιμοποιήσετε τα αποτελέσματα που είναι αποθηκευμένα στην οντότητα εξόδου. Επιλέξτε **Μάθετε σχετικά με αυτήν τη βαθμολογία** για να κατανοήσετε καλύτερα τα μεγέθη απόδοσης του μοντέλου στα οποία βασίζεται το μοντέλο και τον τρόπο παραγωγής του τελικού μοντέλου απόδοσης.
  ...
  - Α όταν το μοντέλο πρόβλεψε με ακρίβεια τουλάχιστον 5% περισσότερους πελάτες υψηλής αξίας σε σύγκριση με το μοντέλο γραμμής βάσης.
  - Β όταν το μοντέλο πρόβλεψε με ακρίβεια μεταξύ 0-5% περισσότερους πελάτες υψηλής αξίας σε σύγκριση με το μοντέλο γραμμής βάσης.
...
Οι προβλέψεις ανανεώνονται αυτόματα με τον ίδιο [προγραμματισμό που ανανεώνονται τα δεδομένα](system.md#schedule-tab) σας, όπως έχουν ρυθμιστεί στις ρυθμίσεις. Μπορείτε να τα ανανεώσετε και με μη αυτόματο τρόπο.

1. Μεταβείτε στην **Ευφυΐα** > **Προβλέψεις** και επιλέξτε την καρτέλα **Οι προβλέψεις μου**.
2. Επιλέξτε τις κατακόρυφες ελλείψεις δίπλα στην πρόβλεψη που θέλετε να ανανεώσετε.
3. Επιλέξτε **Ανανέωση**.
