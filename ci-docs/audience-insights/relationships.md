...
Οι οργανισμοί δημιουργούν ιεραρχίες λογαριασμών για την καλύτερη διαχείριση των λογαριασμών και των σχέσεων μεταξύ τους. Η ικανότητα πληροφοριών κοινού υποστηρίζει γονικές-θυγατρικές ιεραρχίες λογαριασμών που υπάρχουν ήδη σε προσλαμβανόμενα δεδομένα πελατών. Για παράδειγμα, λογαριασμοί από το Dynamics 365 Sales. Αυτές οι ιεραρχίες μπορούν να ρυθμιστούν στη σελίδα **Σχέσεις** σε πληροφορίες κοινού στην καρτέλα ιεραρχίας λογαριασμών.
