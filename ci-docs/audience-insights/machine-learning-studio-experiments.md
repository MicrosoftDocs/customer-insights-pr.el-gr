...
1. Καταγράψτε τα απαιτούμενα στοιχεία για να [δημιουργήσετε τον χώρο εργασίας](/azure/machine-learning/studio/create-workspace). Επιλέξτε το **επίπεδο τιμολόγησης σχεδίου υπηρεσίας Web** με βάση την ποσότητα των δεδομένων που σχεδιάζετε να εισαγάγετε. Για βέλτιστη απόδοση, επιλέξτε τη **Θέση** που είναι πλησιέστερη σε εσάς γεωγραφικά.
...
1. Μετά τη δημιουργία του πόρου, θα εμφανιστεί ο πίνακας εργαλείων του χώρου εργασία του Στούντιο εκμάθησης μηχανής. Επιλέξτε **Έναρξη Στούντιο εκμάθησης μηχανής**.
   ...
   ![Περιβάλλον εργασίας χρήστη του Στούντιο εκμάθησης μηχανής Azure.](media/azure-machine-learning-studio.png)
...
1. Εάν δημιουργήσετε ένα νέο πείραμα ή χρησιμοποιήσετε ένα πρότυπο πειράματος από τη συλλογή, θα πρέπει να ρυθμίσετε τις παραμέτρους των ιδιοτήτων **Εισαγωγή δεδομένων**. Χρησιμοποιήστε την καθοδηγούμενη εμπειρία ή παρέχετε απευθείας λεπτομέρειες για πρόσβαση στον χώρο αποθήκευσης αντικειμένων BLOB Azure που περιέχει τα δεδομένα σας.  
   ...
   ![Πείραμα του Στούντιο εκμάθησης μηχανής Azure.](media/azure-machine-learning-studio-experiment.png)
...
Θα χρησιμοποιήσουμε ένα φανταστικό σενάριο του ξενοδοχείου Contoso για τα μοντέλα σε αυτό το άρθρο. Το ξενοδοχείο Contoso συγκεντρώνει τα ακόλουθα δεδομένα:
...
Για να χρησιμοποιήσετε αυτές τις προβλέψεις στο Customer Insights, θα πρέπει να **εξαγάγετε** τις προβλέψεις μαζί με τα αναγνωριστικά πελάτη. [Εξαγάγετέ τα στην ίδια θέση αποθήκευσης αντικειμένων blob Azure](/azure/storage/common/storage-import-export-data-from-blobs) με αυτήν στην οποία εξάγετε τα δεδομένα προέλευσης. Η προγνωστική υπηρεσία Web μπορεί να προγραμματιστεί για την τακτική εκτέλεση και την ενημέρωση των βαθμολογιών.
