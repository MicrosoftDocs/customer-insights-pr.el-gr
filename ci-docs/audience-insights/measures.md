...
Αυτή η ενότητα σας παρουσιάζει τη δημιουργία ενός νέου μεγέθους από το μηδέν. Μπορείτε να δημιουργήσετε μια μέτρηση με χαρακτηριστικά δεδομένων από οντότητες δεδομένων με μια σχέση που έχει ρυθμιστεί για σύνδεση με την ενοποιημένη οντότητα προφίλ πελάτη.
