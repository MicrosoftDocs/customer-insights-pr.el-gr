...
> [!NOTE]
> Δημιουργούμε μια προεπιλεγμένη ρύθμιση παραμέτρων ευρετηρίου αναζήτησης στα διαθέσιμα χαρακτηριστικά της οντότητας "πελάτης" από τους ακόλουθους τύπους σημασιολογίας, όπως ορίζεται στη σελίδα αντιστοίχισης.
> - Όνομα, Πατρώνυμο, Επώνυμο, Πλήρες όνομα
> - Όνομα οργανισμού
