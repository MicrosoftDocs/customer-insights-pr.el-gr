...
> [!NOTE]
> Έως τον Μάρτιο του 2021, οι εξαγωγές δημιούργησαν αυτόματα μια σύνδεση στην αντίστοιχη υπηρεσία. Οι εξαγωγές τώρα απαιτούν μια [σύνδεση, που έχει δημιουργηθεί και κοινοποιηθεί από έναν διαχειριστή](connections.md) για να μπορείτε να τις δημιουργήσετε.
