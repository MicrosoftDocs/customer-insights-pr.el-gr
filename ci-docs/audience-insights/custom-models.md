...
- Προς το παρόν, αυτή η δυνατότητα υποστηρίζει υπηρεσίες web δημοσιευμένες μέσω [Στούντιο εκμάθησης μηχανής (κλασικό) ](https://studio.azureml.net) και [διοχετεύσεις δέσμης εκμάθησης μηχανής](/azure/machine-learning/concept-ml-pipelines).
...
1. Επιλέξτε την υπηρεσία web Στούντιο εκμάθησης μηχανής (κλασικό) ή τη διοχέτευση εκμάθησης μηχανής Azure στην αναπτυσσόμενη λίστα **Υπηρεσία web που περιέχει το μοντέλο σας**. Στη συνέχεια, επιλέξτε **Επόμενο**.
   - Μάθετε περισσότερα σχετικά με [τη δημοσίευση μιας υπηρεσίας web στο Στούντιο εκμάθησης μηχανής (κλασικό)](/azure/machine-learning/studio/deploy-a-machine-learning-web-service#deploy-it-as-a-new-web-service)
