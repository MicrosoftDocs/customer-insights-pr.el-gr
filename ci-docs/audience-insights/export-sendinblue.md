...
- Έως 1 εκατομμύριο προφίλ ανά εξαγωγή στο Sendinblue.
- Η εξαγωγή στο Sendinblue περιορίζεται σε τμήματα.
- Η εξαγωγή τμημάτων με συνολικό αριθμό 1 εκατομμυρίων προφίλ μπορεί να διαρκέσει έως και 90 λεπτά. 
- Ο αριθμός των προφίλ που μπορείτε να εξαγάγετε στο Sendinblue εξαρτάται και περιορίζεται από τη σύμβαση με το Sendinblue.
