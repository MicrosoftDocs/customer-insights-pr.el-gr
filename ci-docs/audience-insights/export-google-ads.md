...
- Έως 1 εκατομμύριο πελατών ανά εξαγωγή στο Google Ads.
- Η εξαγωγή στο Google Ads περιορίζεται σε τμήματα.
- Η εξαγωγή τμημάτων με συνολικό αριθμό 1 εκατομμυρίου προφίλ πελατών μπορεί να διαρκέσει έως και 5 λεπτά λόγω περιορισμών από την πλευρά του παρόχου. 
