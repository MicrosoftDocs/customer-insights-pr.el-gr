...
> - Μόνο μία οντότητα ιστορικού συναλλαγών μπορεί να ρυθμιστεί αυτήν τη στιγμή. Εάν υπάρχουν πολλές οντότητες αγοράς, να τις ενώσειτε σε Power Query πριν την εισαγωγή δεδομένων.
...
1. Ελέγξτε όλα τα σφάλματα. Υπάρχουν διάφοροι τύποι σφαλμάτων που μπορεί να προκύψουν και περιγράφουν ποια συνθήκη προκάλεσε το σφάλμα. Για παράδειγμα, ένα σφάλμα ότι δεν υπάρουν ακρετά δεδομένα για την ακριβή πρόβλεψη συνήθως επιλύεται με τη φόρτωση περισσότερων δεδομένων στο Customer Insights.
