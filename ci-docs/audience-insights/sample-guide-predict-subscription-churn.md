...
Η Contoso είναι μια εταιρεία που παράγει μηχανές καφέ και καφέ υψηλής ποιότητας, τις οποίες πουλάει μέσω της ιστοσελίδας της Contoso Coffee. Πρόσφατα, άρχισαν μια επιχειρηματική συνδρομή για τους πελάτες τους, για να παίρνουν τακτικά τον καφέ τους. Σκοπός τους είναι η κατανόηση ποιοι εγγεγραμμένοι πελάτες ενδέχεται να ακυρώσουν τη συνδρομή τους στους επόμενους μήνες. Η γνώση του ποιος από τους πελάτες τους είναι **πιθανό να χαθεί**, μπορεί να τους βοηθήσει να σώσουν τις προσπάθειες μάρκετινγκ εστιάζοντας στη διατήρησή τους.
