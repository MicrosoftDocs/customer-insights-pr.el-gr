...
- Προκειμένου τα δεδομένα του Dynamics 365 να αντιστοιχιστούν στα προφίλ πελατών γνώσεων κοινού που πρέπει να [χρησιμοποιηθούν από την εφαρμογή Dynamics 365 χρησιμοποιώντας τον σύνδεσμο Microsoft Dataverse](connect-power-query.md).
