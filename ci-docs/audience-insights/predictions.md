...
1. Ο οργανισμός σας έχει μια παρουσία [που έχει ρυθμιστεί στο Common Data Service](/ai-builder/build-model#prerequisites) και είναι στον ίδιο οργανισμό με το Customer Insights.
