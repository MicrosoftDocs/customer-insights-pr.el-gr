...
- Μπορείτε να εξαγάγετε έως και 250.000 προφίλ τη φορά στο AdRoll.
- Δεν μπορείτε να εξαγάγετε τμήματα με λιγότερα από 100 προφίλ στο AdRoll. 
- Η εξαγωγή στο AdRoll περιορίζεται σε τμήματα.
- Η εξαγωγή έως 250.000 προφίλ στο AdRoll μπορεί να διαρκέσει έως και 10 λεπτά. 
- Ο αριθμός των προφίλ που μπορείτε να εξαγάγετε στο AdRoll εξαρτάται από τη σύμβαση με το AdRoll.
