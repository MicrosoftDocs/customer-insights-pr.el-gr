...
- Ένας [Λογαριασμός Autopilot](https://www.autopilothq.com/) και τα αντίστοιχα διαπιστευτήρια διαχειριστή.
- Ένα [Κλειδί Autopilot API](https://autopilot.docs.apiary.io/#)
...
- Έως και 100.000 προφίλ πελατών ανά εξαγωγή στον Autopilot, η ολοκλήρωση των οποίων μπορεί να διαρκέσει έως και μερικές ώρες. Ο αριθμός των προφίλ πελατών που μπορείτε να εξαγάγετε στον Autopilot εξαρτάται από το συμβόλαιό σας με τον Autopilot.
- Μόνο τμήματα.
...
1. Επιλέξτε **Προσθήκη σύνδεσης** και επιλέξτε **Autopilot**.
...
1. Πληκτρολογήστε το κλειδί API του Autopilot.
...
1. Στο πεδίο **Σύνδεση για εξαγωγή**, επιλέξτε μια σύνδεση από την ενότητα Autopilot. Επικοινωνήστε με έναν διαχειριστή εάν δεν υπάρχει διαθέσιμη σύνδεση.
...
1. Προαιρετικά, εξάγετε άλλα πεδία όπως π.χ **Όνομα** και **Επίθετο**.

1. Επιλέξτε τα τμήματα που θέλετε να εξαγάγετε τηρώντας τους γνωστούς περιορισμούς.
