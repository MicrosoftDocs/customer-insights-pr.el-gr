...
1. Στο Customer Insights, μεταβείτε στα **Δεδομένα** > **Προελεύσεις δεδομένων**.
...
6. Επιλέξτε τους πίνακες που θέλετε να προσλάβετε ως οντότητες στο Customer Insights από τη διαθέσιμη λίστα.    
