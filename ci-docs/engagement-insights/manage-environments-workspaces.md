...
1. Εάν ρυθμίσετε μια [σύνδεση στις πληροφορίες κοινού](configure-connections.md), μπορείτε να επιλέξετε **Να επιτρέπεται η πρόσβαση στα δεδομένα προφίλ** ώστε το μέλος να μπορεί να βλέπει αναφορές με βάση [τα προφίλ χρήστη](profile-reports.md).
...
Ως διαχειριστής περιβάλλοντος, μπορείτε να έχετε πρόσβαση σε ένα περιβάλλον από το αριστερό τμήμα παραθύρου. Μπορείτε να ρυθμίσετε τις παραμέτρους περιβάλλοντος, άλλων διαχειριστών περιβάλλοντος, χώρων εργασίας και [συνδέσεων για τις πληροφορίες κοινού](configure-connections.md). Επιλέξτε καρτέλες για μετακίνηση μεταξύ διαφορετικών περιοχών στο κέντρο διαχείρισης.
...
Για περισσότερες πληροφορίες, ανατρέξτε στο θέμα [Ρύθμιση παραμέτρων συνδέσεων](configure-connections.md).
