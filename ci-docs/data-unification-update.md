...
1. Αφού κάνετε τις αλλαγές σας, επιλέξτε την επόμενη επιλογή:
   ...
   - [Ενοποιήστε προφίλ πελατών](#run-updates-to-the-unified-customer-profile) για να εκτελέσετε συνθήκες αντιστοίχησης και να ενημερώστε την οντότητα ενοποιημένο προφίλ πελάτη χωρίς να επηρεάζει τις εξαρτήσεις (όπως ο εμπλουτισμός, τα τμήματα ή τα μέτρα). Οι εξαρτώμενες διεργασίες δεν εκτελούνται, αλλά θα ανανεώνονται όπως [ορίζεται στο χρονοδιάγραμμα ανανέωσης](system.md#schedule-tab).
...
1. Από τη σελίδα **Δεδομένα** > **Ενοποίηση**, επιλέξτε:
   ...
   - **Ενοποιήστε προφίλ πελατών**: Εκτελεί συνθήκες αντιστοίχησης και ενημερώνει την οντότητα ενοποιημένο προφίλ πελάτη χωρίς να επηρεάζει τις εξαρτήσεις (όπως οι εμπλουτισμοί, τα τμήματα ή τα μέτρα). Οι εξαρτώμενες διεργασίες δεν εκτελούνται, αλλά θα ανανεώνονται όπως [ορίζεται στο χρονοδιάγραμμα ανανέωσης](system.md#schedule-tab).
