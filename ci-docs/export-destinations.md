...
- Οι **εξαγωγές τμήματος** σας επιτρέπουν να εξαγάγετε οντότητες τμήματος από το Customer Insights. Τα τμήματα αντιπροσωπεύουν μια λίστα προφίλ πελατών. Κατά τη ρύθμιση παραμέτρων της εξαγωγής, επιλέγετε τα πεδία δεδομένων που περιλαμβάνονται, ανάλογα με το σύστημα προορισμού στο οποίο κάνετε εξαγωγή των δεδομένων. 
