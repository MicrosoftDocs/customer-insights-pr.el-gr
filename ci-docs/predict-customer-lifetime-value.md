...
1. Στο βήμα **Πρόσθετα δεδομένα (προαιρετικά)**, επιλέξτε **Προσθήκη δεδομένων** υπό το **Ενισχύστε τις πληροφορίες μοντέλων με πρόσθετα δεδομένα δραστηριότητας**. Επιλέξτε την οντότητα δραστηριότητας πελάτη που παρέχει τις πληροφορίες δραστηριότητας του πελάτη, όπως περιγράφεται στις [προϋποθέσεις](#prerequisites).
...
1. Προσθέστε προαιρετικά δεδομένα πελατών ή επιλέξτε **Επόμενο**.
...
1. Στο βήμα **Πρόσθετα δεδομένα (προαιρετικά)**, επιλέξτε **Προσθήκη δεδομένων** υπό το **Ενισχύστε ακόμη περισσότερο τις πληροφορίες μοντέλων με πρόσθετα δεδομένα πελατών**.

1. Για την **Οντότητα**, επιλέξτε **Πελάτης : CustomerInsights** για να επιλέξετε τον ενοποιημένο πίνακα προφίλ πελάτη που αντιστοιχίζεται στα δεδομένα χαρακτηριστικών πελατών. Για **Αναγνωριστικό πελάτη**, επιλέξτε **System.Customer.CustomerId**.
...
1. Επιλέξτε **Αποθήκευση** αφού αντιστοιχίσετε τα χαρακτηριστικά που πρέπει να χρησιμοποιήσει το μοντέλο για να βοηθήσει στην πρόβλεψη της αξίας του πελάτη σε όλο τον κύκλο της ζωής του.
