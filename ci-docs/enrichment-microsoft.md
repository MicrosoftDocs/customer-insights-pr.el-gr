---
title: Εμπλουτισμός προφίλ πελατών με δεδομένα επωνυμιών και ενδιαφερόντων από τη Microsoft (έκδοση προεπισκόπησης)
...
ms.locfileid: "9081499"
---
# <a name="enrich-customer-profiles-with-brands-and-interests-data-from-microsoft-preview"></a>Εμπλουτισμός προφίλ πελατών με δεδομένα επωνυμιών και ενδιαφερόντων από τη Microsoft (έκδοση προεπισκόπησης)
